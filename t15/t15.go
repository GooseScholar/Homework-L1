...
/*Все верно работает, если все символы однобайтовые(например только англиский текст, ascii), иначе нужны руны
...
func someFunc() {
	...
	r := []rune(v)
	//Бля руны можно спокойно брать первые 100 символов и Никогда не будет обрезанных символов
